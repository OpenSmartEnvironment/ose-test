...
exports.add('Get space', function(cb) {  // {{{2
  O.getSpace('testSpace', function(err, space) {
    ...
    Equal(O.subjectState.READY, space._state, 'exports.space state');
...
exports.add('Find shard', function(cb) {  // {{{2
  exports.space.findShard('testShard', function(err, shard) {
    ...
    Equal(O.subjectState.READY, shard._state, 'exports.shard state');
...
exports.add('Find entry', function(cb) {  // {{{2
  exports.shard.find(Alias, function(err, entry) {
    ...
    Equal(O.subjectState.READY, entry._state, 'Entry state');
